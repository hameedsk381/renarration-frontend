import { ADD_RENNARATED_BLOCK, REMOVE_RENNARATED_BLOCK, RESET_RENNARATIONS, UPDATE_RENNARATED_BLOCK } from "../actions/rennarationActions";
    ...
    switch (action.type) {
        ...
        case REMOVE_RENNARATED_BLOCK:
            ...
            case UPDATE_RENNARATED_BLOCK:
                return {
                    ...state,
                    rennaratedBlocks: state.rennaratedBlocks.map(block => 
