...
import { Box, FormControlLabel, Switch, Button, Grid } from '@mui/material';

const AnnotationNavbar = ({ annotationMode, handleAnnotationModeChange, handleExit, navigateToRenarrationBlocks, annotatedBlocks }) => (
