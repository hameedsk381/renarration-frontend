import { Avatar, Box, Button, Card, CardActions, CardContent, CardHeader, CardMedia, IconButton, Typography, Snackbar, Alert } from '@mui/material'
...
const RenarrationBlock = ({block,noActions}) => {
